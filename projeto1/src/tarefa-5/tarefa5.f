!     Testes de tempo para algoritmo da transformada de Fourier.
      ...
      open(1, file="../tarefa-2/output-signal-n50.dat")
      open(2, file="../tarefa-2/output-signal-n100.dat")
      open(3, file="../tarefa-2/output-signal-n200.dat")
      open(4, file="../tarefa-2/output-signal-n400.dat")
