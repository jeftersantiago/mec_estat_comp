...
set linestyle 1 lt 3 lw 1 lc rgb "gray"

# set multiplot layout 1,2 \
# 
plot "output-signal1.dat" w l ls 1 notitle,\
     "output-signal1.dat" w p pt 7 pointsize 1 t "$a_1 = 2, a_2 = 4, \\omega_1 = 4\\pi(Hz), \\omega_2=2.5\\pi(Hz)$"
